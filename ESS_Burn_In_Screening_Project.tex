...
\begin{itemize}[nosep]
  ...
  \begin{itemize}
    \item Isolation Forest on engineered features,
...
\]
\[
\text{risk\_score}=\min\left(1,\max\left(\frac{\max(0,R_{\mathrm{lot}})}{z_{\mathrm{extreme}}},\frac{\max(0,R_{\mathrm{hist}})}{z_{\mathrm{extreme}}},\frac{p_{\mathrm{if}}}{100},\frac{p_{\mathrm{mah}}}{100}\right)\right)
\]
where \(p_{\mathrm{if}}\), \(p_{\mathrm{mah}}\) are Isolation Forest and Mahalanobis percentiles; static failure or major data issues force risk \(=1\).
